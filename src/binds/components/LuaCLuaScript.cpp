...
const luaL_Reg LuaCLuaScript::luaBinds_f[] = {
	{ "new", lua_Create },
	{ NULL, NULL }
};

const luaL_Reg LuaCLuaScript::luaBinds_m[] = {
	{"Create", lua_Create},
...
int LuaCLuaScript::lua_Create(lua_State* L)
{
	...
	binder.pushusertype(v, "CScript", sizeof(CLuaScript));
	return 1;
}
...
int LuaCLuaScript::lua_GetScript(lua_State* L)
{
	...
	binder.pushusertype(v, "Script", sizeof(LuaScript));
	return 1;
}
